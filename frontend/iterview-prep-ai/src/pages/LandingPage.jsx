...
//   return (
//     <>
//       <div className="w-screen min-h-full bg-[#FFFCEF] overflow-x-hidden">
//         <div className="w-[500px] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0"></div>
//         <div className="w-full px-4 pt-6 pb-[200px] relative z-10">
//           {/* Header */}
//           <header className="flex justify-between items-center mb-16">
//             <div className="text-xl text-black font-bold">
//               Interview Prep AI
...
//             {/* Text Section */}
//             <div className="w-full md:w-1/2 px-2 md:pr-4 mb-8 md:mb-0 text-center md:text-left">
